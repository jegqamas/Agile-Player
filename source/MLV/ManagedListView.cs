...
namespace MLV
{
    ...
    public partial class ManagedListView : UserControl
    {
        ...
        /// <summary>
        /// Indicates if columns can be clicked or not.
        /// </summary>
        [Description("Indicates if columns can be clicked or not."), Category("ManagedListView")]
        public bool AllowColumnsClick
        { get { return ManagedListViewPanel1.AllowColumnClick; } set { ManagedListViewPanel1.AllowColumnClick = value; } }
        /// <summary>
        ...
        /// <summary>
        /// Get or set if the control should draw grid lines of the items in details mode.
        /// </summary>
        [Description("Get or set if the control should draw grid lines of the items in details mode"), Category("ManagedListView")]
        public bool DrawGridLinesInDetailsMode
        {
            get { return ManagedListViewPanel1.DrawGridLines; }
            set { ManagedListViewPanel1.DrawGridLines = value; }
        }
        /// <summary>
        /// Get or set if the control should show info of highlighted item when the mouse over it.
        /// </summary>
        [Description("Get or set if more than one item can be selected in the control."), Category("ManagedListView")]
        public bool ItemMultiSelect
        {
            get { return ManagedListViewPanel1.AllowItemMultiSelect; }
            set { ManagedListViewPanel1.AllowItemMultiSelect = value; }
        }
        #endregion
        ...
        public bool IsItemVisible(ManagedListViewItem item)
        {
            return IsItemVisible(ManagedListViewPanel1.items.IndexOf(item));
        }
        public bool IsItemVisible(int itemIndex)
        {
            return ManagedListViewPanel1.IsItemVisible(itemIndex);
        }
        #endregion
